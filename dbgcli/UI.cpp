    ...
    : wxFrame(parent, id, title, pos, size, style)
{
    ...
    m_toolbar12->AddTool(wxID_NETWORK, _("Connect..."), wxXmlResource::Get()->LoadBitmap(wxT("placeholder16")), wxNullBitmap, wxITEM_NORMAL, wxT(""), wxT(""), NULL);
    
    m_toolbar12->AddSeparator();
    
    m_toolbar12->AddTool(wxID_FORWARD, _("Next"), wxArtProvider::GetBitmap(wxART_GO_DOWN, wxART_TOOLBAR, wxSize(24, 24)), wxNullBitmap, wxITEM_NORMAL, wxT(""), wxT(""), NULL);
    
    m_toolbar12->AddTool(wxID_DOWN, _("Step In"), wxArtProvider::GetBitmap(wxART_GO_FORWARD, wxART_TOOLBAR, wxSize(24, 24)), wxNullBitmap, wxITEM_NORMAL, wxT(""), wxT(""), NULL);
    
    m_toolbar12->AddTool(wxID_UP, _("Step Out"), wxArtProvider::GetBitmap(wxART_GO_BACK, wxART_TOOLBAR, wxSize(24, 24)), wxNullBitmap, wxITEM_NORMAL, wxT(""), wxT(""), NULL);
    
    m_toolbar12->AddTool(wxID_EXECUTE, _("Continue"), wxNullBitmap, wxNullBitmap, wxITEM_NORMAL, wxT(""), wxT(""), NULL);
    ...
    m_staticTextSelectDebugFileName = new wxStaticText(m_panel2, wxID_ANY, _("Debug File Name"), wxDefaultPosition, wxDLG_UNIT(m_panel2, wxSize(-1,-1)), 0);
    
    flexGridSizer51->Add(m_staticTextSelectDebugFileName, 0, wxLEFT|wxTOP|wxBOTTOM|wxALIGN_CENTER_VERTICAL, WXC_FROM_DIP(5));
    
    m_filePickerSelectDebugFileName = new wxFilePickerCtrl(m_panel2, wxID_ANY, wxEmptyString, _("Select a file"), wxT("*"), wxDefaultPosition, wxDLG_UNIT(m_panel2, wxSize(600,-1)), wxFLP_DEFAULT_STYLE|wxFLP_SMALL);
    
    flexGridSizer51->Add(m_filePickerSelectDebugFileName, 1, wxEXPAND, WXC_FROM_DIP(5));
    
    m_splitter4 = new wxSplitterWindow(m_panel2, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel2, wxSize(-1,-1)), wxSP_LIVE_UPDATE|wxSP_NO_XP_THEME|wxSP_3DSASH);
    ...
    m_splitterPageSourceFile = new wxPanel(m_splitter4, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitter4, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    
    wxBoxSizer* boxSizerSourceFile = new wxBoxSizer(wxVERTICAL);
    m_splitterPageSourceFile->SetSizer(boxSizerSourceFile);
    
    m_stcTextSourceFile = new wxStyledTextCtrl(m_splitterPageSourceFile, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPageSourceFile, wxSize(-1,-1)), 0);
    ...
    m_splitterPageDAPDebugInfo = new wxPanel(m_splitter4, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitter4, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_notebookDAPDebugInfo = new wxNotebook(m_splitterPageDAPDebugInfo, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_splitterPageDAPDebugInfo, wxSize(-1,-1)), wxBK_DEFAULT);
    ...
    m_panel18 = new wxPanel(m_notebookDAPDebugInfo, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_notebookDAPDebugInfo, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_panel19 = new wxPanel(m_notebookDAPDebugInfo, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_notebookDAPDebugInfo, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_stcThreads = new wxStyledTextCtrl(m_panel19, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel19, wxSize(-1,-1)), 0);
    // Configure the fold margin
    ...
    m_panel27 = new wxPanel(m_notebookDAPDebugInfo, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_notebookDAPDebugInfo, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_panel30 = new wxPanel(m_notebookDAPDebugInfo, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_notebookDAPDebugInfo, wxSize(-1,-1)), wxTAB_TRAVERSAL);
    ...
    m_stcScopes = new wxStyledTextCtrl(m_panel30, wxID_ANY, wxDefaultPosition, wxDLG_UNIT(m_panel30, wxSize(-1,-1)), 0);
    // Configure the fold margin
